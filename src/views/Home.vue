<template>
  <div class="body">
    ...
    <div class=" ">
      ...
      <div
        class="pt-44 pb-8 p-5 h-5 flex items-center justify-center text-7xl font-rubik sm:text-9xl flex-shrink"
      >
      ...
      <div class="content">
        ...
        <div class="p-8 h-4 flex items-center justify-center pt-10">
          ...
          >
            <router-link to="first">Alone</router-link>
          </button>
        </div>
      </div>
    </div>
...
<style>
.body {
  background-image: url("/images/v1.mp4");
  height: 100%;
  width: 100%;
